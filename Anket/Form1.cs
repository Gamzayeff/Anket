...
namespace Anket
{
    public partial class Form1 : Form
    {
        ...
        private void addButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Invalid name! Ad minimum 3 herifli olmalidir", "NAME WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }

            else if (surnameTextBox.Text.Length < 5)
            {
                MessageBox.Show("Invalid surname! Soyad minumum 5 herifli olmalidir", "SURNAME WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }

            else if (emailTextBox.Text.EndsWith("@gmail.com") == false)
            {
                MessageBox.Show("Invalid email! Emailin sonu mutleq @gmail.com olmalidir", "EMAIL WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }

            else if (emailTextBox.Text.Length < 16)
            {
                MessageBox.Show("Invalid email! Email adiniz minumum 6 herfli olmalidir", "EMAIL WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);

            }

            else if (Regex.IsMatch(phoneTextBox.Text, pattern) == false)
            {
                MessageBox.Show("Invalid phone! Telefon nomreniz duzgun olmalidir", "PHONE WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            if (listBox1.Items.Count != 0 && fileNameTextBox.Text.Length != 0)
            {
                ...
                {
                    MessageBox.Show("Invalid file name! Daxil etdiyiniz file adinda file movcuddur", "FILE NAME WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            ...
            {
                MessageBox.Show("Invalid anket! ListBoxunuzda artiq anket var", "ANKET WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }

            else if (fileNameTextBox.Text.Length == 0)
            {
                MessageBox.Show("Invalid file name! File adini daxil edin", "FILE NAME WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void loadButton_Click(object sender, EventArgs e)
        {
            if (fileNameTextBox.Text.Length != 0)
            {
                ...
                {
                    MessageBox.Show("Invalid file name! Daxil etdiyiniz file adinda file yoxdur", "FILE NAME WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    fileNameTextBox.Text = "";
                }
            ...
            {
                MessageBox.Show("Invalid file name! File adini daxil etdiniz", "FILE NAME WARNING!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
